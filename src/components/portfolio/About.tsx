...
function StatCard({
  ...
  return (
    ...
    >
      ...
      <div className="mt-2 text-xs leading-snug text-white/50">{label}</div>
    </div>
  );
}
        ...
        <div className="grid gap-16 md:grid-cols-2 md:items-center md:gap-20">
          ...
          >
            ...
            <div
              ...
              style={{
                opacity: inView ? 1 : 0,
                transform: inView ? "translateY(0) rotate(3deg)" : "translateY(-20px) rotate(3deg)",
                transition: "opacity 0.6s ease 0.4s, transform 0.6s ease 0.4s",
              }}
            >
              <div className="text-xs font-bold text-gold">Available</div>
              <div className="text-[10px] text-white/40">for Work</div>
            </div>
            ...
            <div
              ...
              style={{
                opacity: inView ? 1 : 0,
                transform: inView ? "translateY(0) rotate(-2deg)" : "translateY(20px) rotate(-2deg)",
                transition: "opacity 0.6s ease 0.6s, transform 0.6s ease 0.6s",
              }}
            >
              <div className="text-xs font-bold text-gold">Pakistan 🇵🇰</div>
              <div className="text-[10px] text-white/40">Based</div>
            </div>
            ...
            <div
              ...
              style={{
                ...
                transition: isHoveringImage ? "transform 0.1s ease" : "transform 0.5s ease",
              }}
              onMouseMove={handleMouseMove}
              onMouseEnter={() => setIsHoveringImage(true)}
              onMouseLeave={() => { setIsHoveringImage(false); setMousePos({ x: 0, y: 0 }); }}
            >
              {/* Scan line */}
              <div
                ...
                style={{
                  ...
                  transition: scanActive ? "top 1.2s linear" : "none",
                  opacity: 0.8,
                }}
              />
              ...
              <div className="aspect-[4/5] w-full bg-black">
                <img
                  ...
                  style={{
                    ...
                    transform: isHoveringImage ? "scale(1.04)" : "scale(1)",
          ...
          <div>
            ...
            >
              ...
              <span className="text-xs uppercase tracking-[0.3em] text-gold">About Me</span>
            </div>
            ...
            >
              <h2 className="font-display text-4xl font-black text-white md:text-6xl">
                Hassan<br className="hidden md:block" /> Rizwan
              </h2>
              {/* Shine sweep */}
              ...
              {words.map((word, i) => (
                <span
                  ...
                  style={{
                    ...
                    transition: `opacity 0.4s ease ${0.5 + i * 0.02}s, transform 0.4s ease ${0.5 + i * 0.02}s`,
                    marginRight: "4px",
                  }}
                >
                  {word}
